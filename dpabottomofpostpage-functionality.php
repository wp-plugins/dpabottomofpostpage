...
if( $spmybp_bottom == 'End' ) { //message to be placed at end if not dont execute to save CPU usage
...
if( $spmybp_bottom == 'End' ) {
	echo stripslashes($spmybp_tmpstrx); 
	}
...
if( $spmybp_bottom == 'Bottom' ) { //if message is to be displayed at bottom if not don't execute to save CPU usage
...
if ( is_admin() ){	
	...
	add_action( 'wp_footer', 'dpabottomofpostpageEnd', $spmybp_ranking);
}
