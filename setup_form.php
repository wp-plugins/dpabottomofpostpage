...
echo '<p><span style="color:blue;font-size:16px;font-style:normal;">This plugin sets up the data files that hold the messages you want to display at the bottom of every post or page.</p></span>
<p><span style="color:blue;font-size:16px;font-style:normal;">Firstly enter how many messages you want to display at the bottom of every post and at the bottom of every page then hit the Submit key. If you do not want anything displayed enter 0.</span></p>
<p><span style="color:blue;font-size:16px;font-style:normal;">Then fill up the Message Areas with the required html code and hit Save Post Messages button or Save Page Messages button. If you need to delete a message, just delete / cut the contents of that message area and hit the Save Messages button.</span></p>
';
?>
<br>
...
?>
<span style="color:blue">Your Message Area <?php echo $spmy_j; ?> </span>
<?php
}
?>
...
<table>
<tr><td><a target="_blank" href="http://www.dpacu.com">Stops Spam Contact Us Form</a></td><td><a target="_blank" href="http://www.dpacu.com"><img src="<?php echo $spmy_plugins_url.'/ContactUsFormh30.png'; ?>" width="402" height="30"></a></td></tr>
